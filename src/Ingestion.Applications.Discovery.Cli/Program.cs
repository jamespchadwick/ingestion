namespace JamesPChadwick.Ingestion.Applications.Discovery.Cli
{
  ...
  using JamesPChadwick.Ingestion.Applications.Discovery.Cli.Commands;
  using JamesPChadwick.Ingestion.Applications.Discovery.Cli.Modules;
  using MediatR;
  ...
  {
    public static readonly string ApplicationName = "Ingestion-Discovery-Cli";
    ...
    public static async Task Main(string[] args)
    {
      ...
      try
      {
        ...
        using var scope = lifetimeScope.BeginLifetimeScope(ApplicationName);
        {
          ...
          await mediator.Send(new DiscoverFiles());
        }
      }
